  ...
  <div className="text-left">
    <nav aria-label="breadcrumb" class="w-max">
      <ol class="flex w-full flex-wrap items-center rounded-md bg-blue-gray-50 bg-opacity-60 py-2">
        ...
        <li class="flex cursor-pointer items-center font-sans text-sm font-normal leading-normal text-slate-500 antialiased transition-colors duration-300 hover:text-black">
          <a class="opacity-60" href="/event/create">
            <span>Create</span>
          </a>
        </li>
      </ol>
...
<div class="col-lg-8 pb-2">
    <form method="post" action="/event" enctype="multipart/form-data">
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control drop-shadow-sm px-2 py-2 
          mt-1
          block
          w-full
          rounded-md
        ...
        <button type="submit" class=" drop-shadow-lg inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" onclick="return confirm('Are you sure? Order that has been made cannot be changed.')">
